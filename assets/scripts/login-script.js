...
/**
* comment: Memuat inputEmailElement untuk menyimpan input email
* @constant {HTMLElement}
*/
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /**
  * Comment : Mendapatkan nilai dari input email ketika tombol ditekan. 
  * constant {string}
  */
  const email = inputEmailElement.value;
    /**
  * Comment : Mendapatkan nilai dari input password ketika tombol ditekan. 
  * constant {string}
  */
